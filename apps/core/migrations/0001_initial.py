    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.CharField(choices=[('stripe', 'Stripe Connect'), ('paypal', 'Paypal Business'), ('bank', 'Bank Transfer')], default='bank', max_length=20)),
                ...
                ('bank_sort_code', models.CharField(blank=True, max_length=10, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='CustomUser',
